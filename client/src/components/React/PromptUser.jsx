...
const PromptUser = ({ user }) => {
    ...
    return (
        <main className="h-screen relative flex justify-center flex-col items-center container mx-auto px-4 overflow-hidden" >            
            <div className="overflow-y-auto snap-mandatory snap-y w-2/5 max-md:w-full max-lg:w-3/5 pt-10 pb-24 flex flex-col gap-4" id="inbox">
            ...
            <div id="prompt" className="transition-all duration-300 ease w-full h-12 max-h-max z-1 flex items-end absolute max-md:fixed bottom-10 max-md:bottom-0 justify-center">
                ...
                <textarea 
                    ...
                    aria-multiline maxLength="1000" className="transition-all duration-300 ease focus:rounded-s-lg hover:rounded-s-lg rounded-s-3xl
                    max-md:rounded-3xl
                ...
                <div onClick={() => Submit(false)} id="container-btn-submit" className="transition-all h-full flex justify-center items-center bg-white rounded-e-3xl max-md:absolute max-md:right-0">
