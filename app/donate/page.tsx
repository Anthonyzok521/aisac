    ...
    return (
        <div className="container mx-auto p-4">
            ...
            <ul className="list-disc list-inside mb-4 flex flex-col gap-5">
                <li className="flex justify-start items-center gap-2"><Image className="dark:bg-white rounded-full p-2" alt="Paypal" src={'/brand-paypal.svg'} width={32} height={32}/> <a href="https://paypal.me/anthonyzok521" className="text-blue-500">paypal.me/anthonyzok521 </a></li>
                ...
                <li className="flex justify-start items-center gap-2"><Image className="dark:bg-white rounded-full p-2" alt="USDT" src={'/brand-tether.svg'} width={32} height={32} /><span className="text-gray-700">TANvL9YLZtTdbB4BsfbovhqaVFVZCwav79</span><span className="text-gray-700">Red TRON</span></li>
